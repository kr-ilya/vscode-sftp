...
SyncX is a fork of [Natizyskunk/vscode-sftp](https://github.com/Natizyskunk/vscode-sftp),
itself a fork of [liximomo/vscode-sftp](https://github.com/liximomo/vscode-sftp). Below is
their release history up to 1.16.3, the version this fork starts from, kept for reference.

SyncX's own releases are in the [changelog](../CHANGELOG.md).
